...
urlpatterns = [
    ...
    path('result/<str:folder>/<uuid:id>/drive/', views.retrieve_result_drive, name='retrieve_result_drive'),
    path('result/<str:folder>/<uuid:id>/<str:format>/drive/', views.retrieve_result_drive,
